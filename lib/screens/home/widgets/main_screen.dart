          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 37),
                SvgPicture.asset(findIcon(this.data["condition_slug"]),
                    width: 50),
                Text("${this.data["temp"]}°",
                ...
                Padding(
                  ...
                  child:
                      (SvgPicture.asset("assets/images/vento.svg", width: 32)),
                ),
                Text(this.data["wind_speedy"].toString().toUpperCase()),
                SizedBox(height: 5),
                Week(buildWeek(this.data["forecast"])),
              ],
            ),
          ),
        ),
